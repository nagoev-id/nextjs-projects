export const CONFIG = {
  SUPABASE: {
    URL: process.env.SUPABASE_URL || 'https://ysrdrujxsfpufabyawwj.supabase.co',
    ANON_KEY: process.env.SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InlzcmRydWp4c2ZwdWZhYnlhd3dqIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDk2NDY3MzEsImV4cCI6MjA2NTIyMjczMX0.tupzQfar2hEODbD78LvqYKX5SDfhBrUM1Hn_ojh8yls',
    AUTH: {
      persistSession: true,
      storageKey: 'photo-gallery-auth-token',
